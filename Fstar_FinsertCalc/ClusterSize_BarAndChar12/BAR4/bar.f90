...
program bar
  ...
  real(pr), dimension(360000) :: x,y,z,w
  real(pr), dimension(30000,12) :: xx,yy,zz,ww
  real(pr), dimension(12) :: df1, df2
  ...
  xx=reshape(x,(/30000,12/))
  yy=reshape(y,(/30000,12/))
  zz=reshape(z,(/30000,12/))
  ww=reshape(w,(/30000,12/))

  df1=-log(sum(yy,1)/30000._pr)
  df2=log(sum(ww,1)/30000._pr)
  write(6,*)sum(df1(1:11)),sum(df2(2:12))
